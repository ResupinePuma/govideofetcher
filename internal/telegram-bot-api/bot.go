...
// returned Message.
func (bot *BotAPI) Send(c Chattable) (msgs []Message, err error) {
	...
	if err != nil && strings.Contains(err.Error(), "cannot unmarshal array into Go value of type tgbotapi.Message") {
